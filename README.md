...
- 🖤 Demon (black & red) — cathedral layout: arched window, centered Heart Score medallion with a red sunburst, circular stat gauges, and straight Location / Thoughts / Goal rows
...
| Theme | Dark / Light / Racing (Dark) / Racing (Light) / Idol Stage (Night) / Idol Stage (Day) / Library (Night) / Library (Day) / Demon / Gods. Applies to every card and the quick panel, and is remembered. |
