...
- 🥀 Velvet Noir — case-file "sin ledger" layout: wax-seal Heart Score beside the name, ticket-stub date strip, typewriter ledger rows for stats and info
- 😇 Angel (White & Gold) — centered "cathedral window" layout: arched card, haloed medallion with sunburst rays and wings, circular stat gauges
...
| Theme | Dark / Light / Racing (Dark) / Racing (Light) / Idol Stage (Night) / Idol Stage (Day) / Library (Night) / Library (Day) / Velvet Noir / Angel (White & Gold). Applies to every card and the quick panel, and is remembered. |
